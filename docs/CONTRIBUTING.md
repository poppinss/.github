...
It is never a good experience to have your pull request declined after investing a lot of time and effort in writing the code. Therefore, we highly recommend you to open an issue explaining the proposed changes before starting any new work on your side.

Just create an issue to explain how are you planning to contribute? 
